...
import { Home, LineChart, Package, Package2, Settings, ShoppingCart, Users2, DollarSign, FileText, BarChart, Laptop, Hand, HandCoins, PlusCircle, Banknote, PiggyBank, User, Users, BookA } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        { title: "Dashboard", path: `/`, icon: <Home />, roleField: "dashboard" },
        { title: "Users", path: `/manage-user`, icon: <Users />, roleField: "users" },
        { title: "Projects", path: `/manage-projects`, icon: <BookA />, roleField: "projects" },
        { title: "Course", path: `/user/courses`, icon: <PlusCircle />, roleField: "create courses" },
    ];
